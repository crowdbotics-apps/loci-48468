"""
Django settings for loci_48468 project.
...
WSGI_APPLICATION = 'loci_48468.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Loci Support <support@loci-48468.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "loci_48468 API",
    "DESCRIPTION": "API documentation for loci_48468 App",
    "VERSION": "v1",
}
